  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 py-32">
      <div className="w-full max-w-md">
        ...
        <p className="font-mono text-xs uppercase tracking-[0.3em] text-accent mb-3 text-center">— Welcome Back</p>
        <h1 className="font-display text-4xl md:text-5xl uppercase text-center mb-12">Sign In</h1>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div className="flex justify-end">
            <button type="button" className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground hover:text-accent">
              Forgot password?
            </button>
          </div>
          <button
        ...
        <p className="text-center text-sm text-muted-foreground">
          New to SO.CLOTHING?{" "}
          <Link to="/register" className="text-accent hover:underline font-mono text-xs uppercase tracking-widest ml-1">Create account →</Link>
        </p>
